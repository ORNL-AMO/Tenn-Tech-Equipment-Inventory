 ...
 *
 * This contains the prototypes of Optimal Specific Speed Correction calculator including getters and setters for the
 * important fields.
 *
...
class OptimalSpecificSpeedCorrection {
  public:
    ...
    OptimalSpecificSpeedCorrection(const Pump::Style style, const double specificSpeed)
        : specificSpeed(specificSpeed), style(style) {};
