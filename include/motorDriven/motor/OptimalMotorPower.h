...
#ifndef TOOLS_SUITE_OPTIMALMOTORPOWER_H
#define TOOLS_SUITE_OPTIMALMOTORPOWER_H
...
class OptimalMotorPower {
  public:
     ...
     */
    OptimalMotorPower(double motorRatedPower, double motorRPM, Motor::LineFrequency lineFrequency,
                      Motor::EfficiencyClass efficiencyClass, double specifiedEfficiency, double ratedVoltage,
                      double fieldVoltage, double optimalMotorShaftPower)
        : optimalMotorShaftPower(optimalMotorShaftPower), motorRatedPower(motorRatedPower), motorRPM(motorRPM),
          lineFrequency(lineFrequency), ratedVoltage(ratedVoltage), fieldVoltage(fieldVoltage),
     ...
     */
    double getOptimalMotorShaftPower() const { return optimalMotorShaftPower; }

    /**
     * Sets the optimal motor shaft power
     * @param optimalMotorShaftPower double, optimal motor shaft power in hp
     */
    void setMotorShaftPower(double optimalMotorShaftPower) { this->optimalMotorShaftPower = optimalMotorShaftPower; }
...
#endif // TOOLS_SUITE_OPTIMALMOTORPOWER_H
