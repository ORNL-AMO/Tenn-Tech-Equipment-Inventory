...
class BaseGasDensity {
  ...
  private:
    ...
    /**
 * @brief Calculates numerous fan attributes. Note: This function assumes that the member variables pbo, pso,
 saturationPressure, and relativeHumidity already have valid values.
 *
 * @param inputType const, type of input, unitless
 * @param relativeHumidityOrDewPoint double, const, relative humidity in % or Dewpoint in °F
 */
