...
TEST_CASE("Fan203", "[Fan203]") {
    ...
    traverseHoleData = {{0.662, 0.568, 0.546, 0.564, 0.463, 0.507, 0.865, 1.017, 1.247, 1.630},
...
TEST_CASE("FanCurve", "[Fan203][FanCurve]") {
    ...
    std::vector<FanCurveData::BaseCurve> baseCurveData = {
        {0, 22.3, 115},      {14410, 22.5, 154},  {28820, 22.3, 194}, {43230, 21.8, 241},  {57640, 21.2, 293},
        {72050, 20.3, 349},  {86460, 19.3, 406},  {100871, 18, 462},  {115281, 16.5, 515}, {129691, 14.8, 566},
        {144101, 12.7, 615}, {158511, 10.2, 667}, {172921, 7.3, 725}, {187331, 3.7, 789},  {201741, -0.8, 861}};
    ...
    std::vector<ResultData> expected = {{0, 24.3237008519, 126.1802380783, 0},
    ...
    std::vector<FanCurveData::RatedPoint> ratedPointData = {
        {0, 22.3, 115, density, n, nC},      {14410, 22.5, 154, density, n, nC},  {28820, 22.3, 194, density, n, nC},
        {43230, 21.8, 241, density, n, nC},  {57640, 21.2, 293, density, n, nC},  {72050, 20.3, 349, density, n, nC},
        {86460, 19.3, 406, density, n, nC},  {100871, 18, 462, density, n, nC},   {115281, 16.5, 515, density, n, nC},
...
TEST_CASE("BaseGasDensity", "[BaseGasDensity]") {
    auto const bdg = BaseGasDensity(70, 26.62, 29.92, 60, BaseGasDensity::GasType::AIR,
                                    BaseGasDensity::InputType::RelativeHumidity, 1);
    ...
    auto const bdg2 =
        BaseGasDensity(70, 26.62, 29.92, 55.5, BaseGasDensity::GasType::AIR, BaseGasDensity::InputType::DewPoint, 1);
    ...
    auto const bdg3 = BaseGasDensity(70, 26.62, 29.92, 61.2, BaseGasDensity::GasType::AIR,
                                     BaseGasDensity::InputType::WetBulbTemp, 1, 0.24);
    ...
    auto const bdg4 =
        BaseGasDensity(45, 0, 29.28, 50, BaseGasDensity::GasType::AIR, BaseGasDensity::InputType::RelativeHumidity, 1);
