 ...
 *      calculateThermalResistance(): Calculates the Optimal Motor Size
 *
...
double OptimalMotorSize::calculate() {
    ...
    static const std::set<double> motorSize = {
        0,     5,     7.5,   10,    15,    20,    25,    30,    40,    50,    60,    75,    100,   125,   150,   200,
        250,   300,   350,   400,   450,   500,   600,   700,   800,   900,   1000,  1250,  1500,  1750,  2000,  2250,
        2500,  3000,  3500,  4000,  4500,  5000,  5500,  6000,  7000,  8000,  9000,  10000, 11000, 12000, 13000, 14000,
