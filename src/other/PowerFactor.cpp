...
PowerFactor::Output PowerFactor::calculate(const Mode mode, const double input1, const double input2,
    ...
    return {realPower,
            ...
            phaseAngle,
            realDemand,
            fabs(realDemand - apparentPower),
            proposedReactivePower,
            reactivePower - proposedReactivePower};
}
